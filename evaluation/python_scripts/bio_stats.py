...
algo_order = ["QTM-nonuniform-no-init-no-subtree","QTM-nonuniform-editing-init-no-subtree", "QTM-nonuniform-no-init-subtree","QTM-nonuniform-editing-init-subtree-sort"
    ,"QTM-nonuniform-editing-init-subtree-sort"]
